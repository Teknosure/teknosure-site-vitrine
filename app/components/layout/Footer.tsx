          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+33176297899" className="text-sm transition-colors hover:text-white">
                  +33 1 76 29 78 99
                </a>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:contact@teknosure.com" className="text-sm transition-colors hover:text-white">
