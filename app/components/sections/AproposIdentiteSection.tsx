        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-16">
            ...
            <div className="relative w-full max-w-md shrink-0 lg:w-[420px]">
              ...
              {/* Badge flottant */}
              <div className="absolute -bottom-4 -left-4 rounded-xl border border-[var(--primary-border)] bg-white px-5 py-3 shadow-lg">
                <p className="text-xs font-semibold uppercase tracking-wide text-[var(--primary)]">Fondée en 2022</p>
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {pilliers.map((p) => (
              <div
                key={p.title}
                className="group flex flex-col items-center gap-4 rounded-2xl border border-gray-100 p-8 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[var(--primary-border)] hover:shadow-md"
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[var(--primary-light)] text-[var(--primary)] transition-colors group-hover:bg-[var(--primary-dark)] group-hover:text-white">
                  {p.icon}
                </div>
