            ...
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat) => (
                <div key={stat.label} className="group">
                  <p className="text-4xl font-extrabold text-[var(--primary)] transition-colors group-hover:text-cyan-500">
                    {stat.value}
                  </p>
          ...
          <div className="flex w-full items-center justify-center lg:w-[45%] lg:shrink-0">
            <div className="relative w-full overflow-hidden rounded-2xl bg-linear-to-br from-blue-50 to-cyan-50 p-10">
              ...
              <div className="flex flex-col items-center gap-6">
                {/* Badge central */}
                <div className="flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-lg ring-4 ring-[var(--primary-light)]">
                  <svg className="h-12 w-12 text-[var(--primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <p className="text-center text-sm font-medium text-[var(--primary-dark)]">
