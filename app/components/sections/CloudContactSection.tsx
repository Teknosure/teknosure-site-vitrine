            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input id="cloud-tel" name="telephone" type="tel" placeholder="Téléphone" value={form.telephone} onChange={handleChange} className="w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100" />
                </div>
              </div>

              <div>
                <label htmlFor="cloud-entreprise" className="sr-only">Entreprise</label>
                <input id="cloud-entreprise" name="entreprise" type="text" required placeholder="Entreprise *" value={form.entreprise} onChange={handleChange} className="w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100" />
              </div>

              <div>
                <label htmlFor="cloud-sujet" className="sr-only">Besoin</label>
                <select id="cloud-sujet" name="sujet" required value={form.sujet} onChange={handleChange} className="w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100">
              ...
              <div>
                ...
                <textarea id="cloud-message" name="message" rows={4} required placeholder="Décrivez votre infrastructure actuelle et vos objectifs... *" value={form.message} onChange={handleChange} className="w-full resize-none rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100" />
              </div>
