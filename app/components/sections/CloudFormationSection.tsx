  ...
  return (
    <section className="bg-gray-50 py-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="overflow-hidden rounded-2xl border border-[var(--primary-border)] bg-linear-to-br from-blue-50 via-white to-cyan-50 shadow-sm">
            ...
            <div className="flex flex-1 flex-col justify-center">
              ...
              <div className="mb-8 flex flex-wrap gap-2">
                {topics.map((topic) => (
                  <span
                    key={topic}
                    className="rounded-full border border-[var(--primary-border)] bg-white px-3 py-1 text-xs font-semibold text-[var(--primary-dark)] shadow-sm"
                  >
                    {topic}
                  </span>
                ))}
              ...
              <Link
                href="/contact"
                className="inline-flex w-fit items-center gap-2 rounded-full bg-[var(--primary)] px-7 py-3 text-sm font-bold text-white shadow-md transition-all hover:bg-[var(--primary-light)]0 hover:shadow-lg"
              >
