...
const categories = [
  {
    ...
    techs: [
      ...
      { name: "Google Cloud",logo: "/images/tech/googlecloud.svg",   bg: "bg-[var(--primary-light)]",    filter: "invert(40%) sepia(80%) saturate(400%) hue-rotate(185deg)" },
    ],
  },
  {
    ...
    <section className="bg-white py-20">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-14 flex flex-col items-center gap-3">
          <span className="text-xs font-semibold uppercase tracking-widest text-[var(--primary)]">Stack technique</span>
