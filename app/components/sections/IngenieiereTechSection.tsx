...
const categories = [
  {
    ...
    techs: [
      ...
      { name: "TypeScript",   logo: "/images/tech/typescript.svg",   bg: "bg-blue-50",    filter: "invert(30%) sepia(90%) saturate(600%) hue-rotate(200deg)" },
  ...
  },
  {
    ...
    techs: [
      ...
      { name: "Python",       logo: "/images/tech/python.svg",       bg: "bg-blue-50",    filter: "invert(30%) sepia(90%) saturate(600%) hue-rotate(200deg)" },
    ],
  },
  {
    label: "Mobile",
    techs: [
      ...
      { name: "Flutter",       logo: "/images/tech/flutter.svg",     bg: "bg-blue-50",    filter: "invert(30%) sepia(90%) saturate(600%) hue-rotate(185deg)" },
    ],
  },
  {
    label: "DevOps & Cloud",
