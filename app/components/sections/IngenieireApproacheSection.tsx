      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-stretch lg:gap-16">
          ...
          <div className="flex flex-1 flex-col justify-center">
            <span className="mb-3 text-xs font-semibold uppercase tracking-widest text-[var(--primary)]">
              Notre méthode
            </span>
            ...
            <div className="mb-10 grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="flex items-start gap-3 rounded-xl border border-[var(--primary-border)] bg-[var(--primary-light)] p-4">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-linear-to-br from-[var(--primary-dark)] to-[var(--primary)] text-white shadow-sm">
              ...
              {etapes.map((etape, index) => (
                <li key={etape.num} className="group flex items-start gap-4">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-linear-to-br from-[var(--primary-dark)] to-[var(--primary)] text-sm font-bold text-white shadow-md transition-transform duration-300 group-hover:scale-110">
                      {etape.num}
                    </div>
                  ...
                  {/* Contenu */}
                  <div className="pb-2">
                    <h3 className="mb-1 text-sm font-bold text-gray-900 group-hover:text-[var(--primary)] transition-colors">
                      {etape.title}
                    </h3>
