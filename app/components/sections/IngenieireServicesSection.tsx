const services = [
  ...
  },
  {
    ...
    title: "Odoo ERP",
    description:
      "Partenaire Officiel Odoo. Déploiement Community & Enterprise pour digitaliser vos processus métier.",
    features: [
      "Partenaire Officiel Odoo",
      "Déploiement Community & Enterprise",
      "Modules CRM, ventes, achats, RH",
      "Module production & logistique",
