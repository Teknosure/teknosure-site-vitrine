              ...
              {differentiateurs.map((item) => (
                <div key={item.titre} className="group flex gap-5">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-blue-500/40 bg-blue-500/10 text-blue-400 transition-colors group-hover:border-blue-400 group-hover:bg-blue-500/20">
                      {item.icon}
                    </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-2xl border border-gray-700/60 bg-gray-800/50 p-7 backdrop-blur transition-all hover:border-blue-500/30 hover:bg-gray-800"
                >
            ...
            {/* Citation / manifeste */}
            <div className="rounded-2xl border border-blue-500/20 bg-linear-to-br from-blue-600/20 to-cyan-500/10 p-8">
              ...
              <div className="flex items-center gap-3">
                <div className="relative h-10 w-10 overflow-hidden rounded-full ring-2 ring-blue-500/30">
                  <Image
            ...
            <Link
              href="/contact"
              className="flex items-center justify-between rounded-2xl border border-gray-700 bg-gray-800/50 px-7 py-5 transition-all hover:border-blue-500/40 hover:bg-gray-800"
            >
              <div>
