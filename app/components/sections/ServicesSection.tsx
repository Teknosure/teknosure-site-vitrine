  ...
  return (
    <section id="solutions" className="bg-gray-50 py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* Bande CTA */}
        <div className="mt-12 flex flex-col items-center justify-between gap-5 rounded-2xl bg-linear-to-r from-blue-600 to-cyan-500 px-8 py-8 text-white sm:flex-row">
          <div>
          ...
          <Link
            href="/contact"
            className="shrink-0 rounded-full bg-white px-7 py-3 text-sm font-bold text-blue-700 shadow transition-all hover:-translate-y-0.5 hover:shadow-md"
          >
            Parler à un expert
          </Link>
        </div>
