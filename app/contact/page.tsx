...
const expertises = [
  ...
  { label: "Infrastructure & Cloud", href: "/services/cloud", color: "bg-blue-50 text-blue-600 border-blue-100" },
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ── Mini hero ─────────────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-linear-to-br from-blue-700 via-blue-600 to-cyan-500 pt-32 pb-20">
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            {faq.map((item) => (
              <div
                key={item.q}
                className="rounded-2xl border border-gray-100 bg-gray-50 p-6 transition-all hover:border-blue-100 hover:shadow-sm"
              >
